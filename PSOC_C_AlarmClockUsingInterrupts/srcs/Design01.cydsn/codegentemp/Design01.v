...
module top ;
	...
	cy_clock_v1_0
		#(.id("f6bf79b9-d858-4a9e-80a4-b129bf061ed2"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("100000000000"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("2ba8927c-bea1-4b08-b123-d49d50d1cef3"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),

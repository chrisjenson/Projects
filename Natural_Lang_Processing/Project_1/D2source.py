...
#Source code implementing D-Recognize, 
#this time being able to detect matches in a string where the match is not necessarily at the beginning of the string
...
def D_recognize(tape, machine):
    ...
    for x in range(tapeLen + 1):
        ...
        #if not a valid transition, checking for null and non-existance, the Null is needed for edge cases 
...
print('''*** Deliverable 2: Code building on D1, accepts chars before the match ***
